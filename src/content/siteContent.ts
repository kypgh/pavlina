...
export const homeContent: HomeContent = {
  hero: {
    title: "Go Bright",
    subtitle: "Η δύναμη είναι ήδη μέσα σου. Ήρθε η στιγμή να τη βρεις!",
    backgroundImage: "" // Placeholder for background image
  },
  story: {
    content: `Μεγαλώνουμε ακούγοντας τι "πρέπει" να είμαστε. Τι "μπορούμε" και τι "δεν μπορούμε" να καταφέρουμε. Αυτές οι φωνές συχνά γίνονται αντιλήψεις που μας περιορίζουν: ότι δεν είμαστε αρκετές, ότι η ζωή είναι μόνο ένας αγώνας, ότι η χαρά έχει πάντα βαρύ τίμημα… 
...
Αν νιώθεις κι εσύ ότι ήρθε η στιγμή να ξεπεράσεις τις φωνές που σε κρατούν πίσω και να βρεις ξανά το δικό σου φως, είμαι εδώ για να σε υποστηρίξω σε αυτό το ταξίδι. Γιατί μέσα σου υπάρχει ήδη ό,τι χρειάζεσαι για να λάμψεις!`,
  credentials: [
    ...
    "Θετική Ψυχολογία και Coaching Ψυχολογία",
    "Εκπαίδευση σε τεχνικές Γνωσιακής Συμπεριφορικής Προσέγγισης (CBT)",
...
Μέσα στις συνεδρίες μας συνδυάζονται εργαλεία της Θετικής Ψυχολογίας, αρχές της Coaching Ψυχολογίας και τεχνικές από τη Γνωσιακή Συμπεριφορική Προσέγγιση (CBT). Ο στόχος μου δεν είναι να σου δώσω έτοιμες λύσεις, αλλά να δημιουργήσω τον χώρο όπου θα ανακαλύψεις τις δικές σου απαντήσεις.`,
  details: [
    ...
    "Συνδυασμός Θετικής Ψυχολογίας, Coaching Ψυχολογίας και CBT",
    "Βήμα-βήμα πρόοδος στον δικό σου ρυθμό"
  ],
  callToAction: "Αν νιώθεις ότι ήρθε η στιγμή να επενδύσεις στον εαυτό σου, μπορείς να ξεκινήσεις με ένα δωρεάν Discovery Call 20 λεπτών. Είναι μια σύντομη γνωριμία για να δούμε πώς μπορώ να σε στηρίξω, και αν ταιριάζουμε να περπατήσουμε μαζί αυτό το ταξίδι."
};
